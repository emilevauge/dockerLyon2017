      ...
      <Spectacle theme={theme}>
        <Deck transition={["slide"]} transitionDuration={200}>
          ...
          <Slide bgColor="white">
            ...
            <Text margin="40" >Emile Vauge — Docker Lyon 2017</Text>
          </Slide>
          ...
          <Slide bgColor="white">
            <Image src={images.raclette.replace("/", "")} height="600"/>
          </Slide>
          ...
          <Slide >
            ...
            <Text >
            <Link href="https://emilevauge.github.io/dockerLyon2017">emilevauge.github.io/dockerLyon2017</Link>
            </Text>
          </Slide>
